...
static const char *fonts[] = {
	"Arial:size=14:antialias=true",
	"NotoColorEmoji:pixelsize=20:antialias=true"
};
...
static const char *normbgcolor = "#13171b"; /* -nb option; normal background                 */
static const char *normfgcolor = "#668285"; /* -nf option; normal foreground                 */
static const char *selbgcolor  = "#36454F"; /* -sb option; selected background               */
static const char *selfgcolor  = "#668295"; /* -sf option; selected foreground               */
